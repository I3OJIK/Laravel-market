<div>
        ...
        <div class="w-full max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div class="flex sm:flex-col lg:flex-row sm:items-center justify-between">
                <ul class="flex max-sm:flex-col sm:items-center gap-x-14 gap-y-3">
                    <li wire:click="filterOrders('all')"
     ...
     x-data="{
         initFlatpickr() {
             flatpickr(this.$refs.fromDate, {
                 dateFormat: 'd-m-Y',
                 defaultDate: this.$wire.fromDate || '11-01-2023',
                 onChange: (selectedDates, dateStr) => {
                     this.$wire.set('fromDate', dateStr);
                 }
             });
             
             flatpickr(this.$refs.toDate, {
                 dateFormat: 'd-m-Y',
                 defaultDate: this.$wire.toDate || '11-01-2023',
                 onChange: (selectedDates, dateStr) => {
                     this.$wire.set('toDate', dateStr);
                 }
             });
         }
     }"
    ...
    <div class="flex rounded-full py-3 px-4 border border-gray-300 relative">
        <svg class="relative" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input x-ref="fromDate" type="text" 
               ...
               placeholder="11-01-2023" readonly>
    </div>
