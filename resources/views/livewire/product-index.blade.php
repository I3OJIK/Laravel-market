        ...
        <div class="flex flex-col md:flex-row -mx-4">
            ...
            <div class="md:flex-1 px-4">
                ...
                <div class="flex mb-4">
                    ...
                    <div>
                        <span class="font-bold text-gray-700 dark:text-gray-300">Availability: {{$selectedStock}}</span>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <button class="w-6 h-6 rounded-full {{$color->color_class}} mr-2"
                            wire:click="selectColor({{ $color->pivot->stock }})"></button>
                        @endforeach
