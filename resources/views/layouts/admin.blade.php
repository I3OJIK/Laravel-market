                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="space-y-1 pl-11" id="analytics-dropdown">
                                <a href="{{ route('admin.products-index') }}" class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
                                    Все
                                </a>
                                <a href="{{ route('admin.add-product') }}" class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
                                    Добавить
                                </a>
                            </div>
                        </div>
